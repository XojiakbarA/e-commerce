...
import { fetchBanners, fetchCategories, fetchNewProducts, fetchProduct, fetchSearchResults } from '../../api/api'
...
export const getSearchResults = async (title, dispatch) => {
    try {
        const res = await fetchSearchResults(title)
